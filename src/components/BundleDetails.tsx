  ...
  return (
    <div className="min-h-screen bg-gray-100 py-14 px-4 flex flex-col items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 w-full max-w-6xl">
        ...
        <div>
          <div className="mb-8">
            <h2 className="text-xl font-semibold mb-4">Standard Syllabus</h2>
        ...
        <div className="bg-white shadow-lg rounded-2xl p-6 w-full md:max-w-sm mx-auto ">
          ...
          <button className="w-50 mx-auto bg-orange-500 hover:bg-orange-600 text-white font-semibold py-2 rounded-full  flex justify-center transition duration-200">
            Proceed to Checkout
          </button>
          ...
          <div className="text-center ">
            <h3 className="font-bold mb-1 text-md">Learner Archetype</h3>
            <p className="text-sm mb-3">
              Take the quiz to know your learning archetype and get a
              recommended study bundle.
            </p>
            <button className="bg-orange-500 hover:bg-orange-500 text-white font-bold px-4 py-2 rounded-full transition duration-200 text-sm">
              Take Quiz
            </button>
          </div>
        </div>
