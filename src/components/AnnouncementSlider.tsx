  ...
  return (
        ...
        <Slider {...settings}>
          {announcements.map((announcement) => (
            <div key={announcement.id} className="w-full px-2 ">
              <div className=" min-h-[244px] rounded-[24px] px-6 md:px-16 lg:px-28 py-12 md:py-8
               flex flex-col md:flex-row items-center justify-between gap-6"  style={{
    backgroundImage: "url('/svg/a-bg2.svg')",
    ...
    backgroundRepeat: "no-repeat",
                ...
                <div className="flex-1 text-left">
                  <h3 className="text-lg md:text-xl font-semibold text-white font-primary">
                    {announcement.title}
                  </h3>
                  <p className="text-sm font-semibold text-white mt-1 mb-2 font-primary">
