  ...
  return (
    <section className="bg-[#FFF3EC] px-4 py-24 overflow-hidden">
      ...
      <div className="max-w-8xl mx-auto text-center px-4">
        ...
        >
          Unlock your potential with Aurogurukul’s structured and interactive
          learning, guiding you from fundamentals to mastery with AI-enabled
          tools and personalized feedback.
        </motion.p>
      </div>
        ...
        <div className="space-y-10 text-center md:text-left mx-8">
          {leftContent.map((item, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="font-semibold text-[#000] text-[20px] font-primary">
                {item.title}
              </h3>
              <p className="text-[14px] text-[#3F3F3F] font-secondary">
                {item.desc}
              </p>
            </motion.div>
          ))}
        ...
        <div className="space-y-10 text-center md:text-left mx-8">
          {rightContent.map((item, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="font-semibold text-[#222] text-[20px] font-primary">
                {item.title}
              </h3>
